...
* *文档*：请务必参考官方 https://documentation.suse.com/suse-edge/[SUSE Edge 文档] 以及上游文档以获取详细信息。
* *版本*：SUSE Edge 是针对不同 SUSE 组件，经过严格测试并具有明确设计理念的版本。每个 SUSE Edge 版本中各组件的版本可以在 https://documentation.suse.com/suse-edge/support-matrix/html/support-matrix/index.html[SUSE Edge 支持矩阵] 中查看。
