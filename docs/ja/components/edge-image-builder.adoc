...
== SUSE EdgeはどのようにEdge Image Builderを使用しますか？

SUSE Edgeは、さまざまなシナリオに対応するカスタマイズされたSUSE Linux Microイメージの設定を簡単かつ迅速に行うためにEIBを使用します。これらのシナリオには、以下のような仮想マシンおよびベアメタルマシンのブートストラップが含まれます。
