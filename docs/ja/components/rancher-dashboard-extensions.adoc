...
拡張機能を使用すると、ユーザー、開発者、パートナー、および顧客がRancher UIを拡張し、強化することができます。SUSE EdgeはKubeVirtダッシュボード用の拡張機能を提供します。

Rancherダッシュボード拡張機能に関する一般的な情報については、`{link-rancher-extensions}[Rancher documentation]`を参照してください。

== インストール

SUSE Edge {version-edge} コンポーネント（ダッシュボード拡張機能を含む）は、OCIアーティファクトとして配布されます。SUSE Edge拡張機能をインストールするには、RancherダッシュボードUI、Helm、またはFleetを使用できます。
