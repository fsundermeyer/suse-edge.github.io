...
| コンテナ化データインポーター | {version-cdi} | {version-cdi-chart}
| KubeVirt ダッシュボード拡張機能 | {version-kubevirt-dashboard-extension-chart} | {version-kubevirt-dashboard-extension-chart}
...
| Akriダッシュボード拡張機能 | {version-akri-dashboard-extension-chart} | {version-akri-dashboard-extension-chart}
| Akri (テクノロジープレビュー) | 最新 | 最新
|======
