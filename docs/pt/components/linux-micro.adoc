...
== Como o SUSE Edge usa o SUSE Linux Micro?
...
O SUSE Edge usa o <<components-eib,Edge Image Builder>> para pré-configurar a imagem de instalação autoinstalável do SUSE Linux Micro.
