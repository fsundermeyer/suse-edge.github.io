...
[WARNING]
====
O Edge Image Builder {version-eib} oferece suporte à personalização de imagens do SUSE Linux Micro {version-sl-micro}.
...
* Uma imagem ISO SelfInstall do SUSE Linux Micro {version-sl-micro} criada usando o <<guides-kiwi-builder-images,procedimento do Kiwi Builder>>
...
A imagem de contêiner do EIB está disponível publicamente e pode ser baixada do registro do SUSE Edge executando o seguinte comando em seu host de compilação de imagem:
