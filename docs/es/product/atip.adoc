...
SUSE Telco Cloud (anteriormente conocido como SUSE Edge para Telco) es una plataforma informática optimizada para telecomunicaciones que permite a los operadores de telecomunicaciones y a los proveedores de redes de telecomunicaciones innovar y acelerar la modernización de sus redes.
