...
== Uso de Rancher en SUSE Edge

Rancher proporciona varias funcionalidades principales a la pila de SUSE Edge:
...
El catálogo de aplicaciones integrado de Rancher puede simplificar el despliegue y la gestión de aplicaciones en contenedores en los clústeres de SUSE Edge, lo que permite el despliegue de cargas de trabajo edge de forma fluida.
