...
== ¿Cómo utiliza SUSE Edge SUSE Linux Micro?
...
SUSE Edge utiliza el <<components-eib,Edge Image Builder>> para preconfigurar la imagen de instalación autoinstalable de SUSE Linux Micro.
