...
== ¿Cómo utiliza SUSE Edge Elemental?
...
NOTE: En SUSE Edge {version-edge} *no* aprovechamos los aspectos de gestión del sistema operativo de Elemental y, por tanto, no es posible gestionar la aplicación de parches de su sistema operativo a través de Rancher. En lugar de utilizar las herramientas de Elemental para crear imágenes de ampliación, SUSE Edge utiliza las herramientas de Edge Image Builder, que consumen la configuración de registro.

== Prácticas recomendadas

=== Medios de instalación

La forma recomendada por SUSE Edge de crear imágenes de ampliación que puedan aprovechar Elemental para el registro en Rancher en la huella de ampliación de «phone home network provisioning» es seguir las instrucciones detalladas en el <<quickstart-elemental,incorporación de hosts remotos con Elemental>> quickstart.
